...
You can use jquery-dateFormat without jQuery. You just need to import the dateFormat.js above and instead of using $.format(...) you should use DateFormat.format(...).

Otherwise you will need jQuery 1.4+, which must be loaded before jquery-dateFormat.js.
